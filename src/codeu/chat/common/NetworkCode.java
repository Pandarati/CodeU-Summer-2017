...
public final class NetworkCode {
  ...
  public static final int
      ...
      REMOVE_USER_INTEREST_REQUEST = 19,
      REMOVE_USER_INTEREST_RESPONSE = 20,
      REMOVE_CONVERSATION_INTEREST_REQUEST = 21,
      REMOVE_CONVERSATION_INTEREST_RESPONSE = 22,
      STATUS_UPDATE_REQUEST = 23,
      STATUS_UPDATE_RESPONSE = 24,
      ...
      ADD_MEMBER_REQUEST = 40,
      ADD_MEMBER_RESPONSE = 41,
      ADD_OWNER_REQUEST = 42,
      ADD_OWNER_RESPONSE = 43,
      REMOVE_MEMBER_REQUEST = 44,
      REMOVE_MEMBER_RESPONSE = 45,
      REMOVE_OWNER_REQUEST = 46,
      REMOVE_OWNER_RESPONSE = 47,
      PERMISSION_JOIN_CONVERSATION_REQUEST = 48,
      PERMISSION_JOIN_CONVERSATION_RESPONSE = 49;
}
